<div 
    ...
    style="display: none;"
>
    <div @click.away="close()" class="bg-white rounded-lg p-6 w-full max-w-2xl shadow-lg overflow-y-auto max-h-[90vh]">
        <h2 class="text-xl font-semibold mb-4">Tambah Post</h2>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea x-model="form.content" rows="5" class="w-full border px-3 py-2 rounded"></textarea>
            ...
            <div>
                ...
                <input type="file" multiple @change="handleFileUpload($event)" class="w-full border px-3 py-2 rounded">
            ...
            <div>
                ...
                <input type="text" x-model="form.category" class="w-full border px-3 py-2 rounded">
            ...
            <div>
                ...
                <input type="text" x-model="form.tags" class="w-full border px-3 py-2 rounded">
