...
<!-- card body -->
  ...
  <h4 class="text-3xl text-gray-700 mb-5 flex items-center">Buat Post</h4>
  <div class="p-10 rounded-md shadow-md bg-white">
   ...
   <div class="mb-6">
    ...
    <input
     type="text" name="title" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest"/>
       @error('title')
   ...
   <textarea name="content" id="" cols="80" rows="10"></textarea></textarea>
     @error('content')
      <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
     @enderror
   </div>
   ...
   <div class="mb-6">
    ...
    <input
     type="text" name="category" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest" />
       @error('category')
    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
    @enderror
   </div>
    ...
    <input
     type="text" name="tags" class="border border-gray-500 rounded-md inline-block py-2 px-3 w-full text-gray-600 tracking-widest" placeholder="tags (coma-separated)" />
       @error('tags')
    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
    @enderror
   </div>
